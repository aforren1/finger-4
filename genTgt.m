...
mkTRTgt(1, 3, 0, 0, 0, 2); % (day, block, easy, swapped, img_type, reps)
mkTRTgt(1, 4, 0, 0, 0, 2);

% ambiguous symbols
mkRapidTgt(1, 5, 0, 1, 25); % (day, block, swapped, img_type, reps)
mkRapidTgt(1, 6, 0, 1, 25);
mkTRTgt(1, 7, 0, 0, 1, 2); % (day, block, easy, swapped, img_type, reps)
mkTRTgt(1, 8, 0, 0, 1, 2);
